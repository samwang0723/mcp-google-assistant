# MCP Google Assistant Server

AI-powered Google Gmail/Calendar MCP server
...
```bash
# Build Docker image
docker build -t mcp-google-assistant-server .

# Run container
docker run -p 3000:3000 --env-file .env mcp-google-assistant-server
```
